...
{
  /* Test_Transmission */
  CUSTOM_STM_TEST_READ_EVT,
  CUSTOM_STM_TEST_WRITE_NO_RESP_EVT,
  /* Transmit_Data */
  CUSTOM_STM_DATA_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DATA_NOTIFY_DISABLED_EVT,
  CUSTOM_STM_DATA_INDICATE_ENABLED_EVT,
  CUSTOM_STM_DATA_INDICATE_DISABLED_EVT,
