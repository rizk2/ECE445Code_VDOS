...
typedef struct{
  ...
  uint16_t  CustomTestHdle;                  /**< Test_Transmission handle */
  uint16_t  CustomDataHdle;                  /**< Transmit_Data handle */
...
#define COPY_MY_P2P_SERVER_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x00,0xcc,0x7a,0x48,0x2a,0x98,0x4a,0x7f,0x2e,0xd5,0xb3,0xe5,0x8f)
#define COPY_TEST_TRANSMISSION_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x41,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
#define COPY_TRANSMIT_DATA_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x42,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   *                                2 for Test_Transmission +
   *                                2 for Transmit_Data +
   *                                1 for Transmit_Data configuration descriptor +
   *                              = 6
   *
...
tBleStatus Custom_STM_App_Update_Char_Ext(uint16_t Connection_Handle, Custom_STM_Char_Opcode_t CharOpcode, uint8_t *pPayload)
{
  ...
  switch (CharOpcode)
  {
    ...
    case CUSTOM_STM_TEST:
      ...
      ret = Generic_STM_App_Update_Char_Ext(Connection_Handle, CustomContext.CustomP2PsHdle, CustomContext.CustomTestHdle, SizeTest, pPayload);
    ...
    case CUSTOM_STM_DATA:
      ...
      ret = Generic_STM_App_Update_Char_Ext(Connection_Handle, CustomContext.CustomP2PsHdle, CustomContext.CustomDataHdle, SizeData, pPayload);
